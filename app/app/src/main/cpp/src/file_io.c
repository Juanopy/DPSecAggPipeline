...
psf_open_rsrc(SF_PRIVATE *psf) {
    ...
    count = snprintf(psf->rsrc.path.c, sizeof(psf->rsrc.path.c), "%s/..namedfork/rsrc",
                     psf->file.path.c);
    ...
    */
    count = snprintf(psf->rsrc.path.c, sizeof(psf->rsrc.path.c), "%s._%s", psf->file.dir.c,
                     psf->file.name.c);
    psf->error = SFE_NO_ERROR;
    ...
    */
    count = snprintf(psf->rsrc.path.c, sizeof(psf->rsrc.path.c), "%s.AppleDouble/%s",
