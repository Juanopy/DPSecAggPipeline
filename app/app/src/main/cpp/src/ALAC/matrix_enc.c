...
void
mix16(const int32_t *in, uint32_t stride, int32_t *u, int32_t *v, int32_t numSamples,
...
void
mix20(const int32_t *in, uint32_t stride, int32_t *u, int32_t *v, int32_t numSamples,
      int32_t mixbits, int32_t mixres) {
    int32_t l, r;
    int32_t j;
