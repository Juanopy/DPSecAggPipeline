...
void
unmix16(const int32_t *u, int32_t *v, int32_t *out, uint32_t stride, int32_t numSamples,
...
void
unmix20(const int32_t *u, int32_t *v, int32_t *out, uint32_t stride, int32_t numSamples,
        int32_t mixbits, int32_t mixres) {
    int32_t j;
...
void
copyPredictorTo24Shift(const int32_t *in, uint16_t *shift, int32_t *out, uint32_t stride,
...
void
copyPredictorTo32Shift(const int32_t *in, uint16_t *shift, int32_t *out, uint32_t stride,
                       int32_t numSamples, int32_t bytesShifted) {
    int32_t *op = out;
