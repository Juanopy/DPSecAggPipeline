...
typedef struct {    /* Sync and verify incoming physical bitstream */
...
*/
sf_count_t
ogg_sync_last_page_before(SF_PRIVATE *psf, OGG_PRIVATE *odata, uint64_t *gp_out, sf_count_t offset,
                          int32_t serialno);
