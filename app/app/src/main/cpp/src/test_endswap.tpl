...
endswap_[+ (get "name") +]
_copy (first, orig, ARRAY_LEN (first));
endswap_[+ (get "name") +]
_copy (second, first, ARRAY_LEN (second));
...
_copy (first, orig, ARRAY_LEN (first));
endswap_[+ (get "name") +]
_copy (first, first, ARRAY_LEN (first));
